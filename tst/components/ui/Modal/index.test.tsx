...
describe('Modal', () => {
  ...
  it(`will not close the modal using ESC key if "dismissible" prop is set to "true"`, () => {
    const component = (
      <Modal size="md" rootId="modal-root" onClose={jest.fn()} dismissible>
        <p>Dummy Content</p>
      </Modal>
    );
    renderWithTheme(lightTheme, component);
  ...
  it(`will not close the modal by clicking the background if "dismissible" prop is set to "true"`, () => {
    const component = (
      <Modal size="md" rootId="modal-root" onClose={jest.fn()} dismissible>
        <p>Dummy Content</p>
      </Modal>
